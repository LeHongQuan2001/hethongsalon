		...
		<div id="contact" class="wrapper clearfix">
			...
			<div class="main">
				...
				<form  method="post">
					<ul>
						<li>
							...
							<input type="text"name="txttendichvu" placeholder="Enter your full name here." >
						</li>
						<li>
                            <span>Giá dịch vụ</span>
							<input type="text" name="txtgiadichvu"  placeholder="Enter your email address here.">
						</li>
				...
				<?php
					...
					{
						if (empty($_POST["txttendichvu"]) || empty ($_POST["txtgiadichvu"]))
							echo "<script> alert('không được để trống ') </script>;";
						else 
							{
								$insert=$get_data-> in_dichvu($_POST["txttendichvu"],$_POST["txtgiadichvu"]);
								if($insert){
